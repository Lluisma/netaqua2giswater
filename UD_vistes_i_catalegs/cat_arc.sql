...
CREATE OR REPLACE VIEW TMP_CAT_ARC AS
  ...
  SELECT DISTINCT
         CASE 
           ...
           WHEN SECTIPUS='G*A150x160'      AND DIM1=1500 AND DIM2=1800 THEN 'G*A150x160_A'
           WHEN SECTIPUS='G*A150x160'      AND DIM1=1200 AND DIM2=2000 THEN 'G*A150x160_B'
           WHEN SECTIPUS='AUTOMATIC*28/14' AND DIM1=600	 AND DIM2=1600 THEN 'AUTOMATIC*28/14_A'
           WHEN SECTIPUS='AUTOMATIC*28/14' AND DIM1=800	 AND DIM2=1500 THEN 'AUTOMATIC*28/14_B'
           WHEN SECTIPUS='AUTOMATIC*6/19'  AND DIM1=600	 AND DIM2=1200 THEN 'AUTOMATIC*6/19_A'
           WHEN SECTIPUS='AUTOMATIC*6/19'  AND DIM1=600	 AND DIM2=1000 THEN 'AUTOMATIC*6/19_B'
           WHEN SECTIPUS='AUTOMATIC*7/19'  AND DIM1=600	 AND DIM2=1200 THEN 'AUTOMATIC*7/19_A'
           WHEN SECTIPUS='AUTOMATIC*7/19'  AND DIM1=700	 AND DIM2=1000 THEN 'AUTOMATIC*7/19_B'
           WHEN SECTIPUS='G*70x95'         AND DIM3=700  AND DIM4=700  THEN 'G*70x95_A'
           WHEN SECTIPUS='G*70x95'         AND DIM3=700	 AND DIM4=1000 THEN 'G*70x95_B'
           WHEN SECTIPUS='POMPEU2'         AND DIM3=1200 AND DIM4=750  THEN 'POMPEU2_A'
           WHEN SECTIPUS='POMPEU2'         AND DIM3=1400 AND DIM4=750  THEN 'POMPEU2_B'
           --
