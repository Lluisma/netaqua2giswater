...
CREATE OR REPLACE VIEW MAN_ADDFIELDS_VALUE_TMP AS
    ...
    WHERE   T1.GRUP IS NOT NULL
      AND   T2.CATEGORIA <> 'T'
		UNION
		SELECT	ID_TRAM, 5, GRUP, 2, 'PIPE', ID_TRAM  
    FROM    NA_FIGARO.NA_V_TRAM  
    WHERE   GRUP IS NOT NULL
		UNION
		SELECT	ID_TRAM, 5, GRUP, 3, 'PIPE', ID_TRAM  FROM  NA_LLISSADEVALL.NA_V_TRAM  WHERE GRUP IS NOT NULL
		...
		UNION
		SELECT	ID_DIPO, 7, CAST(NIVELL_INI AS VARCHAR(10)), 2, 'DIPOSIT', ID_DIPO  FROM  NA_FIGARO.NA_V_DIPO  WHERE NIVELL_INI IS NOT NULL AND NIVELL_INI > 0
		UNION
		SELECT	ID_DIPO, 7, CAST(NIVELL_INI AS VARCHAR(10)), 3, 'DIPOSIT', ID_DIPO  FROM  NA_LLISSADEVALL.NA_V_DIPO  WHERE NIVELL_INI IS NOT NULL AND NIVELL_INI > 0
		...
		UNION
		SELECT	ID_DIPO, 8, CAST(NIVELL_MIN AS VARCHAR(10)), 2, 'DIPOSIT', ID_DIPO  FROM  NA_FIGARO.NA_V_DIPO  WHERE NIVELL_MIN IS NOT NULL AND NIVELL_MIN > 0
		UNION
		SELECT	ID_DIPO, 8, CAST(NIVELL_MIN AS VARCHAR(10)), 3, 'DIPOSIT', ID_DIPO  FROM  NA_LLISSADEVALL.NA_V_DIPO  WHERE NIVELL_MIN IS NOT NULL AND NIVELL_MIN > 0
    ...
    UNION
    SELECT	ID_DIPO, 9, CAST(NIVELL_MA AS VARCHAR(10)), 2, 'DIPOSIT', ID_DIPO  FROM  NA_FIGARO.NA_V_DIPO  WHERE NIVELL_MA IS NOT NULL AND NIVELL_MA > 0
    UNION
    SELECT	ID_DIPO, 9, CAST(NIVELL_MA AS VARCHAR(10)), 3, 'DIPOSIT', ID_DIPO  FROM  NA_LLISSADEVALL.NA_V_DIPO  WHERE NIVELL_MA IS NOT NULL AND NIVELL_MA > 0
		...
		UNION
		SELECT	ID_DIPO, 10, CAST(DIAMETRE AS VARCHAR(10)), 2, 'DIPOSIT', ID_DIPO  FROM  NA_FIGARO.NA_V_DIPO  WHERE DIAMETRE IS NOT NULL AND DIAMETRE > 0
		UNION
		SELECT	ID_DIPO, 10, CAST(DIAMETRE AS VARCHAR(10)), 3, 'DIPOSIT', ID_DIPO  FROM  NA_LLISSADEVALL.NA_V_DIPO  WHERE DIAMETRE IS NOT NULL AND DIAMETRE > 0	
