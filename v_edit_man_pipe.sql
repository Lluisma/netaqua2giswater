...
FROM    NA_FIGARO.NA_V_TRAM T1
          ...
          LEFT JOIN NA_FIGARO.NA_V_VALV T10 ON T1.ID_NODE1 = T10.ID_VALV AND T1.TIPUS_NODE1 = 'VALV'
          LEFT JOIN NA_FIGARO.NA_V_VALV T11 ON T1.ID_NODE2 = T11.ID_VALV AND T1.TIPUS_NODE2 = 'VALV'
...
FROM    NA_LLISSADEVALL.NA_V_TRAM T1
          ...
          LEFT JOIN CAT_PRESSZONE T9 ON T1.ID_SUBXARXA = T9.LINK
          LEFT JOIN SECTOR T8 ON T9.ID = T8.DESCRIPT
          LEFT JOIN NA_LLISSADEVALL.NA_V_VALV T10 ON T1.ID_NODE1 = T10.ID_VALV AND T1.TIPUS_NODE1 = 'VALV'
          LEFT JOIN NA_LLISSADEVALL.NA_V_VALV T11 ON T1.ID_NODE2 = T11.ID_VALV AND T1.TIPUS_NODE2 = 'VALV';
