...
CREATE OR REPLACE VIEW TMP_V_EDIT_ELEMENT_PORTELLA AS
  ...
  SELECT  'POR1_2_' || T1.ID_ESCO element_id,
          'POR1_2_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
  ...
  SELECT  'POR2_2_' || T1.ID_ESCO element_id,
          'POR2_2_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
  ...
  SELECT  'POR3_2_' || T1.ID_ESCO element_id,
          'POR3_2_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
  ...
  SELECT  'POR1_3_' || T1.ID_ESCO element_id,
          'POR1_3_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
  ...
  SELECT  'POR2_3_' || T1.ID_ESCO element_id,
          'POR2_3_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
  ...
  SELECT  'POR3_3_' || T1.ID_ESCO element_id,
          'POR3_3_' || T1.ID_ESCO code,
	        CASE
            WHEN T2.ID IS NULL THEN 'PORT_XX'
            ELSE T2.ID
          END                     elementcat_id,
