...
UNION ALL
 ...
 SELECT T1.ID_FONT                              connec_id,
        ...
        2                                       muni_id,
        CASE
          WHEN (T1.CARRER1 IS NOT NULL AND T1.CARRER1 <> '0') THEN '081347_' || REPLACE(T1.CARRER1,',1','')
          ELSE null
        END                                     streetaxis_id,
        CAST(null AS INTEGER)                   postnumber,
        null                                    postcomplement,
        CASE
          WHEN (T1.CARRER2 IS NOT NULL AND T1.CARRER2 <> '0') THEN '081347_' || REPLACE(T1.CARRER2,',1','')
          ELSE null
        END                                     streetaxis_id,
        CAST(null AS INTEGER)                   postnumber2,
        null                                    postcomplement2,
...
FROM    NA_FIGARO.NA_V_FONT T1
          LEFT JOIN NA_FIGARO.CAT2_T_FONT_TIPUS T3 ON T1.TIPUS = T3.ID_FONT_TIPUS
...
UNION ALL
 ...
 SELECT T1.ID_FONT                              connec_id,
        ...
        3                                       muni_id,
        CASE
          WHEN (T1.CARRER1 IS NOT NULL AND T1.CARRER1 <> '0') THEN '081081_' || REPLACE(T1.CARRER1,',1','')
          ELSE null
        END                                     streetaxis_id,
        CAST(null AS INTEGER)                   postnumber,
        null                                    postcomplement,
        CASE
          WHEN (T1.CARRER2 IS NOT NULL AND T1.CARRER2 <> '0') THEN '081081_' || REPLACE(T1.CARRER2,',1','')
          ELSE null
        END                                     streetaxis2_id,
        CAST(null AS INTEGER)                   postnumber2,
        null                                    postcomplement2,
...
FROM    NA_LLISSADEVALL.NA_V_FONT T1
          LEFT JOIN NA_LLISSADEVALL.CAT2_T_FONT_TIPUS T3 ON T1.TIPUS = T3.ID_FONT_TIPUS;
