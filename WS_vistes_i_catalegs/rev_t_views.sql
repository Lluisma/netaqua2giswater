...
CREATE OR REPLACE VIEW REV_T_VALVE AS
  ...
  SELECT ID_VALV NODE_ID, ID_VALV CODE, 'VALVULA' NODETYPE_ID, 1 EXPL_ID, INCID_OC, INCID_OM, DATA_DR, DATA_FR, REVI_ESTAT
  ...
  WHERE  INCID_OC IS NOT NULL OR INCID_OM IS NOT NULL OR DATA_DR IS NOT NULL OR DATA_FR IS NOT NULL OR REVI_ESTAT IS NOT NULL 
  UNION
  SELECT ID_VDES NODE_ID, ID_VDES CODE, 'VDESCARREGA' NODETYPE_ID, 1 EXPL_ID, INCID_OC, INCID_OM, DATA_DR, DATA_FR, REVI_ESTAT
