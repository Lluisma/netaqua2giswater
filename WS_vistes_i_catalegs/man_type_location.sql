...
CREATE OR REPLACE VIEW GW_MIGRA_NETAQUA.MAN_TYPE_LOCATION AS 
  ...
  UNION
  SELECT 8, 'FANAL', 'ELEMENT', 'PLACA',     'Fanal' FROM DUAL
  UNION
  SELECT 9, 'PAL',   'ELEMENT', 'PLACA',     'Pal' FROM DUAL
  UNION
  SELECT 8, 'PARET', 'ELEMENT', 'PLACA',     'Paret' FROM DUAL
  UNION
  SELECT 9, 'TANCA', 'ELEMENT', 'PLACA',     'Tanca metàl·lica' FROM DUAL;
